    ...
    <div className={classes.loginPage}>
        ...
        >
            ...
            <Paper className={classes.form} radius={0}>
                ...
                <Container>
                    <TextInput placeholder="New Password" size="md" mb={20} autoComplete='false' classNames={{ input: classes.textField }} />
                    <TextInput placeholder="Confrim Password" size="md" mb={20} autoComplete='false' classNames={{ input: classes.textField }} />
